# Hi there, I'm Biswajit Chowdhury 👋
...
🎥 Media & Streaming     :: RTSP | WebRTC | HLS | RTMP | FFmpeg | SRS / NGINX-RTMP | OpenCV
☁️ Cloud & DevOps        :: AWS (EC2, S3, ECS, Lambda) | Docker | Kubernetes | CI/CD | Linux
📊 Databases & Analytics :: PostgreSQL | MySQL | Redis | MongoDB | Prometheus | Grafana
🤖 AI & Systems          :: GenAI / LLM Workflows | Computer Vision (CCTV) | Microservices
```
